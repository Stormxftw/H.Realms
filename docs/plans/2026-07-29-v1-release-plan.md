...
- LAN addresses are discovered from the host or explicitly configured; no personal public IP or `10.0.0.2` fallback remains in product code.
...
- Review/remove: `downloads/project-zim-architecture-inventory.zip`
