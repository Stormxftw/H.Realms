    ...
    def collect():
        ...
        result: dict[str, Any] = {
            ...
            "connect": {
                ...
                "lan": f"203.0.113.10:{default_port}",
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        try:
            ...
            elif self.path == "/project-architecture-inventory.zip":
                self.send_file(DOWNLOADS / "project-architecture-inventory.zip", "application/zip")
